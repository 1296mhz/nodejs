...
Utils.prototype.chargen = function () {
    var text = "";
...
Utils.prototype.extractNumber = function (numid) {
    var reg = /\d/g;
...
//Выдрать цифровое значение из id (пять букв а далее цифры)
Utils.prototype.extractChars = function (numid) {
...
Utils.prototype.maxNumber = function (array) {
    return Math.max.apply(null, array);
};

Utils.prototype.nowDate = function () {
    var currentDate = moment().format().split('+');
    return currentDate[0];
};

Utils.prototype.isLoggedIn = function (req, res, next) {
        if (!req.user) {
...
Utils.prototype.god = function (req, res, next) {
